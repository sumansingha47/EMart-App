...
import 'package:emart_app_2023_baaba_devs1/views/chat_screen/chat_screen.dart';
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    VxRating(
                      ...
                      selectionColor: const Color.fromARGB(255, 255, 172, 7),
                      count: 5,
                      maxRating: 5,
                      size: 25,
                      stepInt: false,
                    ...
                    onPress: () {
                      if (controller.quantity.value > 0) {
                        ...
                        VxToast.show(context,
                            bgColor: const Color.fromARGB(255, 26, 247, 33),
                            msg: "Added to cart");
                      } else {
                        VxToast.show(context,
